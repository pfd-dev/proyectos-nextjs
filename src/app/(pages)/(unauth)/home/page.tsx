        ...
        <div className="px-4">
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-center md:justify-end pt-1 gap-x-10">
              <a
                href="https://pfd-dev.github.io/pfd-dev/"
                target="_blank"
              ...
              <Link href="https://github.com/pfd-dev" title="GitHub" target="_blank" className={`bg-white text-sky-600 hover:text-sky-500 hover:underline border-4 border-white hover:${tones.borderColor.normal} rounded-xl`}>
